...
public class ComputerPlayer extends Player {
	...
	private Coordinates checkDiagonal(char[][] board, char mark) {
		...
		else if(board[0][0] == board[2][2] && board[0][0] == mark && board[1][1] == ' ') {
			move = new Coordinates(1,1);
			return move;
		}

		else if(board[1][1] == board[2][2] && board[1][1] == mark && board[0][0] == ' ') {
			move = new Coordinates(0,0);
			return move;
		}

		else if(board[0][2] == board[1][1] && board[0][2] == mark && board[2][0] == ' ') {
			move = new Coordinates(2,0);
			return move;
		}

		else if(board[0][2] == board[2][0] && board[0][2] == mark && board[1][1] == ' ') {
			move = new Coordinates(1,1);
			return move;
		}

		else if(board[1][1] == board[2][0] && board[1][1] == mark && board[0][2] == ' ') {
